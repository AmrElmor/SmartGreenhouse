...
public class LDRFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Sensors>> {

    private static final String LOG_TAG = LDRFragment.class.getName();
    /**
     * URL for sensor data from the server dataset
     */
    private static final String Server_REQUEST_URL =
            "http://192.168.137.1:3000/ldr/";
    /**
     * Constant value for the sensor loader ID. We can choose any integer.
     * This really only comes into play if you're using multiple loaders.
     */
    private static final int SENSORS_LOADER_ID = 3;
     ...
     */
    private LDRSensorAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new LDRSensorAdapter(getActivity(), new ArrayList<Sensors>());
    ...
    public Loader<List<Sensors>> onCreateLoader(int i, Bundle bundle) {
        ...
        return new LDRSensorLoader(getActivity(), Server_REQUEST_URL);
    }
