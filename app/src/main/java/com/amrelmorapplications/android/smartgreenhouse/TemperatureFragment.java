...
public class TemperatureFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Sensors>> {
     ...
     */
    private static final int SENSORS_LOADER_ID = 1;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new TemperatureSensorAdapter(getActivity(), new ArrayList<Sensors>());
    ...
    public Loader<List<Sensors>> onCreateLoader(int i, Bundle bundle) {
        ...
        return new TemperatureSensorLoader(getActivity(), Server_REQUEST_URL);
    }
