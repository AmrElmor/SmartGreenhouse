 ...
 */
public final class SoilQueryUtils {

    /**
     * Tag for the log messages
     */
    private static final String LOG_TAG = SoilQueryUtils.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link SoilQueryUtils} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name QueryUtils (and an object instance of QueryUtils is not needed).
     */
    private SoilQueryUtils() {
    }
    ...
    private static List<Sensors> extractFeatureFromJson(String sensorsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < sensorsArray.length(); i++) {
                ...
                int mag = currentSensor.getInt("data");
