...
/**
 * An {@link LDRSensorAdapter} knows how to create a list item layout for each sensor
...
public class LDRSensorAdapter extends ArrayAdapter<Sensors> {

    /**
     * Constructs a new {@link LDRSensorAdapter}.
     *
     * @param context of the app
     * @param sensors is the list of sensors, which is the data source of the adapter
     */
    public LDRSensorAdapter(Context context, List<Sensors> sensors) {
...
// Find the sensor at the given position in the list of sensors
        ...
        } else if (currentSensor.getMag() < 50) {
            TextView primaryLocationView = (TextView) listItemView.findViewById(R.id.reading_status);
            // Display the location of the current earthquake in that TextView
