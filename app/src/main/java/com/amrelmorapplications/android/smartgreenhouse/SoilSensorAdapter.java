...
/**
 * An {@link SoilSensorAdapter} knows how to create a list item layout for each sensor
...
public class SoilSensorAdapter extends ArrayAdapter<Sensors> {

    /**
     * Constructs a new {@link SoilSensorAdapter}.
     *
     * @param context of the app
     * @param sensors is the list of sensors, which is the data source of the adapter
     */
    public SoilSensorAdapter(Context context, List<Sensors> sensors) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        } else if (currentSensor.getMag() < 25) {
            TextView primaryLocationView = (TextView) listItemView.findViewById(R.id.reading_status);
            // Display the location of the current earthquake in that TextView
